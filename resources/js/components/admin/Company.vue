  ...
  <v-col cols="12" class="justify-content-center">
    ...
    <v-dialog
      ...
      <v-card class="col-12">
        ...
        <v-card-text>
          <v-form ref='editcompany' v-model="valid">
            <v-row>
              <v-col>
              ...
              <v-col>
                ...
                <v-text-field v-model="selectedUser.phone" dir="ltr" suffix="05" counter="8" type="phone" placeholder="  الجـوال " prepend-icon="mdi-phone" color="#0c8676" :rules="
                  [
                    () => !!selectedUser.phone || 'This field is required',
                    () => !!selectedUser.phone && selectedUser.phone.length == 8 || 'الرجاء مراجعة رقم الهاتف',
      ...
      data () {
        return {
          ...
          usersheaders:[
            ...
            {text: 'الجهة التابع لها ', value: 'company.regulator'},
            {text: 'المنطقة', value: 'company.city.name'},
