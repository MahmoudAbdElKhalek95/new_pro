...
@section('title' , 'الشركه والفريق ')
@section('content')
<section class="supervisors-accounts">
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-4">
            <h3 class=""><img src="{{ asset('dashboard/assets/images/header_icon1.png') }}" class="me-2">الشركه والفريق </h3>
            ...
            @include('company_team.CreateModel')
            @endif
        </div>
        <div class="supervisors">
           ...
           <div class="table-responsive-xl" style="min-height: 600px;">
            ...
            <tr>
                ...
                <td class="edit-btn ">
                        <a class="btn btn-success"  href="{{ route('company_team.activate' , $item->id ) }}" >
                ...
                <td class="edit-btn ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a class="btn btn-success " href="{{ route('company_team.edit', $item->id) }}">
                                تعديل
                                </a>
                      </div>
                            <div class="col-md-4">
                            ...
                            action="{{ route('company_team.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method("DELETE")
            ...
            <div class="row" >
                ...
                <div class="col-md-4" >
                 {{ $company_team->render("pagination::bootstrap-4") }}
                </div>
                <div class=" col-md-4" >
                </div>
             </div>
