...
@section('title' , 'الروية والفلفسة الخاصة بنا  ')
@section('content')
<section class="supervisors-accounts">
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-4">
            <h3 class=""><img src="{{ asset('dashboard/assets/images/header_icon1.png') }}" class="me-2">الروية والفلفسة الخاصة بنا  </h3>
        ...
        <div class="supervisors">
           ...
           <div class="table-responsive-xl" style="min-height: 600px;">
            ...
            <tr>
                ...
                <td class="edit-btn ">
                        <a class="btn btn-success"  href="{{ route('vision.activate' , $item->id ) }}" >
                ...
                <td class="edit-btn ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a class="btn btn-success " href="{{ route('vision.edit', $item->id) }}">
                                تعديل
                                </a>
                      </div>
                            <div class="col-md-4">
            ...
            <div class="row" >
                ...
                <div class="col-md-4" >
                 {{ $vision->render("pagination::bootstrap-4") }}
                </div>
                <div class=" col-md-4" >
                </div>
             </div>
