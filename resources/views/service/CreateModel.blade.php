      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="header-modal" style="display: flex;justify-content: space-between;align-items: center">
            <h5 class="modal-title" id="exampleModalLabel">أضف انواع من نحن </h5>
        ...
        <div class="form py-5  px-4">
            ...
            <div class="row">
                <div class="w-100 pe-lg-3">
                    <div class="input-field w-100">
                        <label>الوصف  </label>
                          <textarea type="text" rows="4" cols="50" name="description"  placeholder="الوصف">{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                    <div class="alert alert-danger" >
                        {{ $message }}
