...
@section('title' , 'الاستديو')
@section('content')
<section class="supervisors-accounts">
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-4">
            <h3 class=""><img src="{{ asset('dashboard/assets/images/header_icon1.png') }}" class="me-2">  الصور </h3>
            ...
            @include('galary.CreateModel' , [ "id" => $id  , 'type'=> $type ] )
            @endif
        </div>
        <div class="supervisors">
          ...
          @isset( $galarys )
            ...
            <div class="row" >
                ...
                <div class="col-md-4" >
                 {{--  {{ $galarys->render("pagination::bootstrap-4") }}  --}}
                </div>
                <div class=" col-md-4" >
                </div>
             </div>
