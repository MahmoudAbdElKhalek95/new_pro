...
@section('content')
   ...
   <section class="trainers_course">
            ...
            <div class="d-md-flex align-items-center justify-content-between mb-4">
                <h3 class=""><img src="{{ asset('dashboard/assets/images/header_icon1.png') }}" class="me-2">الاخبار</h3>
                ...
                <div class="col-md-6 col-lg-4 p-0 px-md-4" >
                    <div class="course-box" style="overflow-y:scroll !important ">
                        <div class="course-description">
                            ...
                            <div class="course-price">
                                ...
                                <div class="justify-content-center" style="text-align: center">
                                    <a style="text-decoration: none " class="custom-btn"  href="{{ route('news.activate' , $item->id ) }}" >
                        ...
                        <div class="justify-content-center" style="text-align: center">
                            ...
                            <a   target="_blank" href="{{ route('news.edit', $item->id)  }}" class="custom-btn"> تعديل</a>
                            @endif
                        </div>
