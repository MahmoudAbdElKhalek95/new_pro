        ...
        <div class="supervisors">
           ...
           <div class="table-responsive-xl" style="min-height: 600px;">
            <table class="table">
             ...
             @foreach ( $partiner as $item )
            <tr>
                {{--  <td>  <input class="form-check-input" type="checkbox" value=""  id="flexCheckDefault1"></td>  --}}
                <td>  {{ $item->type == 'sponsors' ? 'الشركاء' : 'جهات الاعتماد' }}  </td>
                <td>  <img src= "{{  asset($item->image) }}" alt ="image" width="150px" height="150px">   </td>
           
                <td class="edit-btn ">
                        <a class="btn btn-{{$item->active == 1  ? 'success'  : 'danger'}}"  href="{{ route('partiner.activate' , $item->id ) }}" >
              ...
              <td class="edit-btn ">
                   <div class="row">
                    <div class="col-md-4">
                        <a class="btn btn-success " href="{{ route('partiner.edit', $item->id) }}">
                        تعديل
                     </a>
                  </div>
                        <div class="col-md-4">
                        ...
                        action="{{ route('partiner.destroy', $item->id) }}" method="POST">
                            @csrf
                            @method("DELETE")
            ...
            <div class="row" >
                ...
                <div class="col-md-4" >
                 {{ $partiner->render("pagination::bootstrap-4") }}
                </div>
                <div class=" col-md-4" >
                </div>
             </div>
