...
@section('title', 'المدربين المتقدمين')
...
<section class="supervisors-accounts">
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-4">
            <h3 class=""><img src="{{ asset('dashboard/assets/images/header_icon1.png') }}" class="me-2">المدربين المتقدمين</h3>
              ...
              <tr>
                ...
                <td class="edit-btn ">
                    <a class="btn btn-success "   data-toggle="modal" data-target="#editexampleModal_{{ $item->id }}" >
                      ...
                      @include('trainer.editStatus',  ['id' => $item->id , 'item' => $item ]  )
                </td>
